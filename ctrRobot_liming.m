...
%%
save('D:\Li-Ming\23092022\base\data_base.mat','data');
save('D:\Li-Ming\23092022\base\data_water_static_data_base.mat','data_water_static');
save('D:\Li-Ming\23092022\base\data_air_data_base.mat','data_air');

mean_water_move = [mean(data(:,1)) mean(data(:,2)); mean(data(:,3)) mean(data(:,4)); mean(data(:,5)) mean(data(:,6)); mean(data(:,7)) mean(data(:,8)); mean(data(:,9)) mean(data(:,10))];
mean_water_static = [mean(data_water_static(:,1)) mean(data_water_static(:,2)); mean(data_water_static(:,3)) mean(data_water_static(:,4)); mean(data_water_static(:,5)) mean(data_water_static(:,6)); mean(data_water_static(:,7)) mean(data_water_static(:,8)); mean(data_water_static(:,9)) mean(data_water_static(:,10))];
mean_air = [mean(data_air(:,1)) mean(data_air(:,2)); mean(data_air(:,3)) mean(data_air(:,4)); mean(data_air(:,5)) mean(data_air(:,6)); mean(data_air(:,7)) mean(data_air(:,8)); mean(data_air(:,9)) mean(data_air(:,10))];
